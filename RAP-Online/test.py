...
if __name__ == '__main__':
    ...
    if params.method in ['maml']: # maml do not support testing with feature
        if 'Conv' in params.model:
            image_size = 84 
        # elif ('ResNet' in params.model) and (params.n_shot==5):
        #     image_size = 84
        else:
            image_size = 224
        ...
        model.eval()
        acc_mean, acc_std = model.test_loop(novel_loader, checkpoint_dir=None, return_std = True)
